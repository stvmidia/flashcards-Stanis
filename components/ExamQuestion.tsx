...
export const ExamQuestion: React.FC<ExamQuestionProps> = ({ question, answer, alternatives, correctAlternativeIndex, isAnswerVisible, onToggleAnswer, cardNumber, totalCards }) => {
            ...
            {alternatives.map((alt, index) => {
              ...
              return (
                ...
                >
                  ...
                  {isAnswerVisible && isCorrect && <CheckCircleIcon className="w-6 h-6 text-green-600 ml-2 flex-shrink-0" />}
                </div>
              );
            })}
          </div>
